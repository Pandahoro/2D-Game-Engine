...
//
//public:
//	GameAndCharDemo(HINSTANCE hInstance);
//	~GameAndCharDemo();
//
...
//#endif
//
//	GameAndCharDemo theApp(hInstance);
//
...
//GameAndCharDemo::GameAndCharDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool GameAndCharDemo::Init(bool fullScreen)
//{
...
//void GameAndCharDemo::OnResize()
//{
//	Engine::OnResize();
//}
//
////update scene - here is where our update logic for the game loop goes
//void GameAndCharDemo::UpdateScene(float dt)
//{
...
//}
//
//void GameAndCharDemo::BuildGeometryBuffers()
//{
...
//}
//
//void GameAndCharDemo::DrawScene()
//{
//
...
//		RenderSprite(mBGSprite, activeSpriteTech, true);
//
//		RenderSprite(mDeanyP->mCurrentSprite, activeSpriteTech, true);
//	}
//	break;
//	}
//
...
//}
//
//void GameAndCharDemo::InitAudio()
//{
